        ...
        <div className="mx-auto max-w-6xl px-4 md:px-8">
            {/* Header Section */}
                <div className="mx-auto max-w-5xl text-center">
                    ...
                    {/* Judul */}
                    <h2 className="mt-4 text-4xl md:text-4xl lg:text-6xl font-extrabold leading-tight">
                        <p className="text-[#3b2a20]">Tentang </p>
                        <p className="text-[#D98454]">Desa Pagelaran</p>
                    </h2>

                    {/* Paragraf */}
                    <div className="mt-4 md:mt-2 mx-auto max-w-5xl text-md md:text-lg leading-relaxed text-[#3b2a20] text-justify space-y-5">
                        <p>
            ...
            <div className="mt-12 grid md:grid-cols-2 gap-8 items-stretch">
                {villages.map((item, index) => (
                    <article
                        ...
                        {/* ==== Konten Card ==== */}
                        <h3 className="text-2xl md:text-3xl font-bold text-[#4b2b16] mb-6 text-center">
                            {item.title}
                        </h3>

                        <p className="text-md md:text-lg leading-relaxed text-slate-700 text-justify flex-1">
                            {item.description}
                        </p>
                    </article>
                ))}
