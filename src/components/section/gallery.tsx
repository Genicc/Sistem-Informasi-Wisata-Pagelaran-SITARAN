...
import { getLocalGalleryFromBlob } from "@/lib/getLocalGalleryFromBlob";
import { GalleryGrid } from "@/components/section/galley-grid";

// Biar sama kayak LocalProducts: disable cache ISR
export const revalidate = 0;

export async function GallerySection() {
  // 1. Fetch data dari Vercel Blob (Server Side)
  const blobImages = await getLocalGalleryFromBlob();
    ...
    >
      ...
      <div className="relative mx-auto max-w-8xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-4 text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight text-[#3b2a20]">
            Merekam Jejak{" "}
          </h2>
          <span className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight text-[#D98454]">
